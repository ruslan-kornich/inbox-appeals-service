...
class TicketRepository(BaseRepository[Ticket]):
    ...
    def __init__(self) -> None:
        """
        Initialize repository with the Ticket model.
        """
    ...
    async def update_status_with_audit(  # noqa: PLR0913
        self,
        *,
        ticket_id: str,
        ...
        """
        Update ticket status and set audit fields.

        This includes 'who' and 'when'. Optionally updates staff_comment and staff_assignee.
        """
        ...
        return await self.update_by_id(pk=ticket_id, values=values, using_db=using_db)
